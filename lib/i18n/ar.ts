export const ar = {
  ...
  searchProductsPlaceholder: "البحث حسب اسم المنتج، الرمز، البار كود، العلامة التجارية، أو الفئة...",
  searchCustomersPlaceholder: "البحث حسب اسم الصيدلية، الطبيب، الكود، رقم الهاتف، أو مسؤول المبيعات...",
  searchQuotesPlaceholder: "البحث حسب رقم عرض السعر، اسم الصيدلية، أو الطبيب...",
  searchInvoicesPlaceholder: "البحث حسب رقم الفاتورة، رقم العرض، اسم الصيدلية، أو الطبيب...",
  searchReceiptsPlaceholder: "البحث حسب رقم سند القبض، رقم الفاتورة، اسم الصيدلية، أو الطبيب...",
  searchInventoryPlaceholder: "البحث في المخزون حسب اسم المنتج، الرمز، أو الكود...",
  searchExpensesPlaceholder: "البحث حسب فئة المصروفات، الوصف، أو اسم المستخدم...",
  searchUsersPlaceholder: "البحث حسب اسم المستخدم، البريد، الدور، أو الدولة...",
  searchGeneralPlaceholder: "البحث في السجلات...",
  medName: "اسم الدواء",
  ...
  itemsProductsHeader: "المنتجات / العناصر",
  productHeader: "المنتج",
  discountCol: "الخصم",
  totalCol: "الإجمالي",
  noItemsRecorded: "لا توجد منتجات / عناصر مسجلة لهذه الفاتورة.",
